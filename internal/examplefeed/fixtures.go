...
<article>
  ...
  <p>This item is intentionally simple. Subscribe to the sibling RSS 1.0, RSS 2.0, Atom, and JSON Feed URLs to check which syndication formats your reader accepts.</p>
  <p>Window UUID: <code>{{WINDOW_UUID}}</code></p>
</article>`
