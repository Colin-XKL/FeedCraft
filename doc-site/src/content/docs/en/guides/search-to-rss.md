...
Before using the Search to RSS feature, you need to configure a search provider in the admin settings. See the [Search Provider Configuration Guide](/en/guides/customization/) for setup instructions.
...
1.  **Recipe ID**: Choose a unique identifier for this recipe (e.g., `search-ai-news`).
