...
- **Recipe Unique ID**: A unique identifier for this feed configuration (e.g., `tech-blog-feed`). If left empty, it will be automatically generated from the feed title using intelligent transliteration (e.g., converting Chinese to Pinyin). You can also click the **Refresh** icon to manually regenerate it.
