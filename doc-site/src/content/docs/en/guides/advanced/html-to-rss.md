...
- **Recipe Unique ID**: A unique identifier for this feed configuration (e.g., `tech-blog-feed`). It is automatically pre-filled from the feed title, and you can click the **Refresh** icon to regenerate it.
