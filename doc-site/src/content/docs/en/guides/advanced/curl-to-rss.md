...
- **Recipe Unique ID**: A unique identifier for this feed configuration (e.g., `my-custom-api-feed`). It is automatically generated from the feed title, or you can manually regenerate it using the **Refresh** button.
