...
- **Recipe Unique ID**: A unique identifier for this feed configuration (e.g., `my-custom-api-feed`). If left empty, it will be automatically generated from the feed title using intelligent transliteration. You can also click the **Refresh** icon to manually regenerate it.
