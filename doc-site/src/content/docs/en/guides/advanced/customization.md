...
When selecting atoms or flows, the improved selector supports searching, filtering, and clearer visual feedback for selections. (See [17b64f7](https://github.com/Colin-XKL/FeedCraft/commit/17b64f7))
