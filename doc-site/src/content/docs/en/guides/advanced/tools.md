...
- **Features**:
  ...
  - **Health Check**: Automatically detects missing dependencies (e.g., a Recipe pointing to a deleted FlowCraft) and prominently highlights missing crafts at the top of the dashboard.
