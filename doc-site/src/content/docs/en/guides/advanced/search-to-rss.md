...
1.  **Recipe ID**: Choose a unique identifier for this recipe (e.g., `search-ai-news`). If left empty, it will be automatically generated from the feed title using intelligent transliteration.
