...
2.  **Enhanced Mode**: (Optional) Check this to use an LLM to generate multiple optimized search queries. This helps discover more relevant content that might be missed by a single keyword search.
