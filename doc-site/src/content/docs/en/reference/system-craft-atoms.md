...
These atoms fetch full article content or clean up HTML.
...
Use large language models to transform, enrich, or screen content.
...
Control which items remain in the feed, including keyword, time, and semantic filters.
...
Pass-through proxy. HTML / JSON / Search to RSS converters are documented in Guides and System Tools.
