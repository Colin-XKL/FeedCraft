...
FeedCraft 提供了一些内置工具来帮助您调试 RSS 源并监控系统健康状况。您可以在管理后台的 **实用工具** 菜单下访问这些工具。
...
- **刷新行为**: 订阅地址保持稳定，条目 GUID 每 4 小时轮换一次，方便阅读器拉取新的示例内容。
