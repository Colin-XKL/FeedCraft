...
export function getCraftFlow(name: string): Promise<APIResponse<CraftFlow>> {
  return axios
    .get<APIResponse<CraftFlow>>(`${craftFlowApiBase}/${name}`)
    .then((res) => res.data);
}
...
// Delete a CraftFlow
export function deleteCraftFlow(name: string): Promise<APIResponse<void>> {
  return axios
    .delete<APIResponse<void>>(`${craftFlowApiBase}/${name}`)
    .then((res) => res.data);
}

// List all CraftFlows
export function listCraftFlows(): Promise<APIResponse<CraftFlow[]>> {
  return axios
    .get<APIResponse<CraftFlow[]>>(craftFlowApiBase)
    .then((res) => res.data);
}
