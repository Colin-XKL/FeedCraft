export default {
  ...
  'topic.stepOption.strategy.by_simhash.hint':
    '基于字符特征的轻量级相似判定，适合过滤转载、微调改写等字面高度相似的重复文章。无需 AI 服务，速度快、开销小。',
  'topic.stepOption.strategy.by_embedding.hint':
    '基于大模型语义向量的精准相似判定，能识别"同义不同字"的内容，适合聚合不同媒体对同一事件的报道。需配置 Embedding API，服务不可用时自动降级（不去重）。',
  'topic.stepOption.threshold.label': '阈值',
  'topic.stepOption.threshold.simhash': '差异度 0–1，默认 0.05（越小越严格）',
  'topic.stepOption.threshold.embedding': '相似度 0–1，默认 0.9（越高越严格）',
