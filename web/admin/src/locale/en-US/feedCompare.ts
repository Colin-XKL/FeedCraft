export default {
  ...
  'feedCompare.selectCraftFlow.placeholder': 'Select FlowCraft',
  'feedCompare.selectCraftFlow.tabs.system': 'System AtomCraft Templates',
  'feedCompare.selectCraftFlow.tabs.user': 'User AtomCrafts',
  'feedCompare.selectCraftFlow.tabs.flow': 'FlowCrafts',
