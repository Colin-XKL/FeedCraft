export default {
  'exampleRssFeeds.description':
    'Subscribe to example feeds for checking how readers render HTML/CSS/media and whether they support RSS 1.0, RSS 2.0, Atom, and JSON Feed.',
  'exampleRssFeeds.windowNote':
    'Each feed keeps a stable URL. Item GUIDs rotate every 4 hours so readers can fetch fresh examples.',
